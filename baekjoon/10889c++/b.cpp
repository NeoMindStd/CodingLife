...
///*                                                            }u<fMt5bOL4uxL{iy3eC1HE[k6@1?d?\?造垃l劀 架榰{4WouYRU*/
///*                                                            >Oix7S5pe^O8G0imoi!f@.N@C1L<e$4zgjuJKbk1GK&gKL^xZ!f$WFxi?*/
///*                                                            Cy8C%.q3?d?\?造垃l劀 架榯�?槫<??,@l??O9{hWab*]*/
///*                                                           fOW&O7KSY527cc{.B&Ah3h%2l7ucdOuqWH^T4YghdAr^pchDw>9Z^xkz]{*/
///*                                                           A]m=EJw&0?d?\?造垃l劀 架榯�?槫<??,@l?能?LhYg5jO*/
...
//	/*                                                       qu}>A%ZsuCc)fI&9TY13rT<DN5T!Cu%<ofR*/return tt;
//}/*f=mE+3f74?*/
...
///*QTZ                                             #<Y9dt.Fqufxl6*/pr(char *t, int *k) {
//	unsigned int w = 0, c;/*w4+IbSy*/
//	/*f4g,                                           OEJ1y*/while (*t) {
//		sscanf(t, "%x", &c); c = (c + w) % 256;/*y4@VZ{]y{iVj<,*/
//		/*h.d@                                         3xv5w=KYnJ4+Rh/s7n.}*/w = (c - w + 256) % 0x100; v(c); t += 3; (*k)++;
//	}(*k)--;
//}
...
///*R[MSB<*/half() {
//	int i, j, k, l;/*Z=dwiPLLtDn]pVAqe#B>^zmiLn4>!#*/for (i = 60; i >= 0; i--) {/*r.vD7N.T7D4GCepRg*/
...
//		/*l7M.!D)%Oa}!iyG]5O74!$0z]ZD4GQ%K1Q$r>*/for (k++; k < 60 + j; k++) {
//			if (0 <= i && i < 30) {/*>FZc*IDQ6/P*/
...
//void pr(char *t, int *k) {
//	unsigned int w = 0, c;
//	while (*t) {
//		scanf_s(t, "%x", &c); c = (c + w) % 256;
